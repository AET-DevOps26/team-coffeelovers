...
function DecorativeIcons() {
  return (
    <>
      ...
      <span style={{ ...decoStyle, bottom: "8%",  left: "5%",  fontSize: 48, color: "#9ca3af" }}>↑</span>
      <span style={{ ...decoStyle, bottom: "18%", left: "4%",  fontSize: 32, color: "#f9a825" }}>☀</span>
      <span style={{ ...decoStyle, top: "20%",  right: "4%", fontSize: 36, color: "#93c5fd" }}>▲▲</span>
      <span style={{ ...decoStyle, bottom: "10%", right: "3%", fontSize: 36, color: "#f9a825" }}>☀</span>
      <span style={{ ...decoStyle, top: "6%",   right: "6%", fontSize: 28, color: "#9ca3af" }}>⌖</span>
    </>
  );
}
